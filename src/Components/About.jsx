...
const About = () => {
  return (
    ...
    <div className='About-wrapper flex flex-col justify-center items-center '>
        ...
        <div className="wrapper flex flex-row gap-60 ">
          <div className="img-wrapper h-92  w-40 pt-9">
            <img src={Mypic} alt=""  className=' img-wrapper rounded-full'/>
          </div>
