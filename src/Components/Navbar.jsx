    ...
    <div className='wrapper'>
        <div>
            <div className="desktop-nav flex flex-row items-center justify-around h-17vh font-mono   cursor-pointer text-black-500">
                ...
                <div className="nav-links flex flex-row items-center list-none   cursor-pointer">
                    ...
                    <li className='Project hover:underline hover:text-gray-400 transition-all duration-300 text-2xl hover:text-xl'>Contact</li>
                 </div>
            </div>
